var _statcounter = function (_1) {
    ...
    try {
        ...
        function strip_tags(_32, _33) {
            ...
            var _34 = /<\/?([a-z][a-z0-9]*)\b[^>]*>/gi, _35 = /<!--[\s\S]*?-->|<\?(?:php)?[\s\S]*?\?>/gi;
        ...
        var _4e = 6;
        var _4f = 52;
        var _50 = Math.pow(_4d, _4e), _51 = Math.pow(2, _4f), _52 = _51 * 2, _53 = _4d - 1;
        var _54;
        ...
        function ARC4(key) {
            var t, _60 = key.length, me = this, i = 0, j = me.i = me.j = 0, s = me.S = [];
            if (!_60) {
                key = [_60++]
            }
            while (i < _4d) {
        ...
        function generate_uuid(_79) {
            ...
            _55(_7d);
            var _7e = "0123456789ABCDEF".split(""), _7f = new Array(_79), rnd = 0, r;
            for (var i = 0; i < _79; i++) {
            ...
            if (document.cookie) {
                ...
                for (var i = 0; i < ca.length; i++) {
                    ...
                    if (c.indexOf(_99) == 0) {
                        ...
                        if (ret && _98 !== undefined && ret.indexOf("" + _98 + ".") !== -1 && _9e.indexOf("" + _98 + ".") === -1) {
                        } else {
                            ret = _9e
                        }
                    }
        ...
        function check_root_domains_match(a, b) {
            ...
            if (_c8.length > 1 && ((_c8[_c8.length - 2].length <= 3 && _c8[_c8.length - 1] in {
                ...
                "us": 1,
                "za": 1
            }) || _c8[_c8.length - 1] == "kr" || _c8[_c8.length - 1] == "ru" || (_c8[_c8.length - 1] == "au" && _c8[_c8.length - 2] in {"csiro": 1}) || (_c8[_c8.length - 1] == "at" && _c8[_c8.length - 2] in {"priv": 1}) || (_c8[_c8.length - 1] == "fr" && _c8[_c8.length - 2] in {
                "avocat": 1,
                "aeroport": 1,
                "veterinaire": 1
                ...
                "health": 1,
                "parliament": 1
            }) || (_c8[_c8.length - 1] == "il" && _c8[_c8.length - 2] in {"muni": 1}) || (_c8[_c8.length - 1] == "za" && _c8[_c8.length - 2] in {"school": 1}) || (_c8[_c8.length - 1] == "tr" && _c8[_c8.length - 2] in {"name": 1}) || (_c8[_c8.length - 1] == "uk" && _c8[_c8.length - 2] in {"police": 1}))) {
                _cb = 3
            }
            for (var i = 1; i <= _ca; i++) {
                        ...
                        function delayed_send_pageview() {
                            if (document.webkitVisibilityState != "prerender") {
                                for (var _dd in _4._security_codes) {
                                    send_pageview(parseInt(_dd, 10), "invisible", {"p": 2})
                                }
                ...
                if (_133 != 0) {
                    ...
                    if (_134.length > 0) {
                        ...
                        if (_4._add_recording_event) {
                            _4._add_recording_event(_133 == 1 ? "download" : _133 == 2 ? "exit" : "unknown", {"link": unescape(_134)})
                        }
                        sc_delay()
                    }
                }
                ...
                if (_186.length) {
                    ...
                    var _189 = new MutationObserver(function () {
                        ...
                        if (document.title != _187 && _18a != _188) {
                            ...
                            if (_4._add_recording_event) {
                                _4._add_recording_event("history-pageload", {"referrer": _188, "href": _18a})
                            }
                            _187 = document.title;
                            _188 = _18a
                        }
                    });
                    _189.observe(_186[0], {childList: true, attributes: false, subtree: false})
                }
            } catch (ei) {
            }
        }
